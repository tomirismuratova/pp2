...
#добавляем класс Coin для отображения монет и подсчета количества монет
...
class Coin(pygame.sprite.Sprite):
    ...
    def move(self):
        global COINS
        global SPEED
        #добавление разного количества монет 
...
while True:
    ...
    for entity in all_sprites:
        ...
        #увеличить количество монет, если произошло столкновение
        if entity == C1:
    ...
    #переместить вторую случайную машину
    ...
    for coin in coinss:
        ...
        #возрождать монеты если ушли за экран
